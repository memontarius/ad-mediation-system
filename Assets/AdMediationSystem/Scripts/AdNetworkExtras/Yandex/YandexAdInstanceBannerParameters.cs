namespace Virterix.AdMediation
{
    public class YandexAdInstanceBannerParameters : AdInstanceParameters
    {
        ...
        {
            var parameters =
                CreateParameters<YandexAdInstanceBannerParameters>(_AD_INSTANCE_PARAMETERS_FOLDER,
        ...
        {
            var parameters = CreateParameters<YandexAdInstanceBannerParameters>(projectName,
