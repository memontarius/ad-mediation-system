namespace Virterix.AdMediation
{
    public class UnityAdInstanceBannerParameters : AdInstanceParameters
    {
        ...
        {
            var parameters =
                CreateParameters<UnityAdInstanceBannerParameters>(_AD_INSTANCE_PARAMETERS_FOLDER,
        ...
        {
            var parameters = CreateParameters<UnityAdInstanceBannerParameters>(projectName,
